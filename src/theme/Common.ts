...
export const profileAssetUrl = 'https://storage.googleapis.com/links_dev/UserProfilePictures/'
export const postImageAssetUrl = 'https://storage.googleapis.com/links_dev/PostImages/'