...
export const FocusedNotificaionIcon = (props: SvgProps) => (
  <Svg
    width={26}
    height={30}
    fill="none"
  ...
  >
    <Path
      fill="#fff"
      d="M24.696 21.423c-1.75-2.115-2.984-3.192-2.984-9.024 0-5.341-2.76-7.244-5.032-8.168-.302-.123-.586-.404-.678-.71C15.603 2.18 14.486 1 13 1c-1.485 0-2.603 1.181-2.998 2.522-.092.31-.376.586-.677.709-2.275.925-5.033 2.821-5.033 8.168-.003 5.832-1.238 6.909-2.988 9.024-.725.877-.09 2.192 1.178 2.192h21.042c1.261 0 1.892-1.32 1.171-2.192Zm-7.335 2.192v1.077c0 1.143-.46 2.238-1.277 3.046A4.387 4.387 0 0 1 13 29a4.387 4.387 0 0 1-3.083-1.262 4.282 4.282 0 0 1-1.277-3.046v-1.077"
    />
    <Path
      stroke="#000"
      strokeLinecap="round"
