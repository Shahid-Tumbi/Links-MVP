...
export const WhiteBell = (props: SvgProps) => (
  <Svg
    width={26}
    height={30}
    fill="none"
...
export const Sun = (props: SvgProps) => (
  ...
  >
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={1.5}
      d="M11 1v1m0 18v1m10-10h-1M2 11H1"
    />
    <Path
      stroke="#F8F8F8"
      strokeLinecap="round"
      strokeWidth={1.5}
      d="m18.07 3.93-.392.393M4.322 17.678l-.393.393m14.141-.001-.392-.393M4.322 4.322l-.393-.393"
      opacity={0.5}
    />
  </Svg>
)
