...
class ShareViewController: SLComposeServiceViewController {
 ...
 let hostAppBundleIdentifier = "com.linksbynk"
 let shareProtocol = "wtfnewsapp" //share url protocol (must be unique to your app, suggest using your apple bundle id, ie: `hostAppBundleIdentifier`)
